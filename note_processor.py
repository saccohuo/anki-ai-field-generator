...
class NoteProcessor:
    ...
    """
    def __init__(self, prompt_config: PromptConfig, notes: list[AnkiNote], client: OpenAIClient):
    ...
    def fill_string_with_note_fields(self, s: str, note: AnkiNote, missing_field_is_error = False) -> str:
        """
    ...
    def get_user_prompt(self, note: AnkiNote, missing_field_is_error = False) -> str:
        return self.fill_string_with_note_fields(self.prompt_config.user_prompt, note, missing_field_is_error)
